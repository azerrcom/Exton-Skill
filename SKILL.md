---
name: exton-wallet
description: Manage Exton TON crypto wallet — send GRAM/jettons, manage plugins (whitelist, daily-limit, subscriptions, payroll), sign transactions via Keystone 3 Pro QR.
...
Пользователь просит: создать кошелёк, баланс, отправить GRAM/токены/NFT, проверить лимиты, историю транзакций, резолвить .ton домен.
...
"✅ Транзакция подтверждена! Баланс: X GRAM"
...
- Входящие: "Получено X GRAM от адреса..."
- Исходящие: "Отправлено X GRAM на адрес..."
- Текущий баланс
...
- Входящие: "💰 Получено X GRAM от UQabc..."
- Исходящие: "📤 Отправлено X GRAM на UQxyz..."
- Текущий баланс
...
- Daily Limit: максимум N GRAM за 24 часа (on-chain counter с auto-reset)
...
| daily-limit | Макс N GRAM/сутки | Owner |
...
| auto-swap | Jetton → GRAM через DEX | Owner |
